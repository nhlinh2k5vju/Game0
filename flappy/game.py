...
floor = pygame.transform.scale2x(pygame.image.load('floor.png').convert())
floor_x_pos = 0
...
#bird = pygame.transform.scale2x(pygame.image.load('yellowbird-midflap.png').convert_alpha())
bird_rect = bird.get_rect(center = (100,348))
birdflap = pygame.USEREVENT + 1
pygame.time.set_timer(birdflap,200)
pipe_surface = pygame.transform.scale2x(pygame.image.load('pipe-green.png').convert())
pipe_list = []
